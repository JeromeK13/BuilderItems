...
{	
	...
	class bldr_picture_g: HouseNoDestruct
	{
		scope=1;
		model="\DZ\structures\furniture\decoration\wallboards\picture_g\picture_g.p3d";
	};	
	class bldr_picture_g_02: HouseNoDestruct
	{
		scope=1;
