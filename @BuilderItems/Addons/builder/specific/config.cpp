...
class CfgVehicles
{
	...
	class bldr_Autodrome_01: HouseNoDestruct
	{
		scope=1;
		model="\DZ\structures\specific\lunapark\proxy\autodrome_01.p3d";
	};
	class bldr_Autodrome_02: HouseNoDestruct
	{
		scope=1;
		model="\DZ\structures\specific\lunapark\proxy\autodrome_02.p3d";
	};
	class bldr_Autodrome_03: HouseNoDestruct
	{
		scope=1;
		model="\DZ\structures\specific\lunapark\proxy\autodrome_03.p3d";
	};
	class bldr_Autodrome_04: HouseNoDestruct
	{
		scope=1;
		model="\DZ\structures\specific\lunapark\proxy\autodrome_04.p3d";
	};
	class bldr_Autodrome_05: HouseNoDestruct
	{
		scope=1;
		model="\DZ\structures\specific\lunapark\proxy\autodrome_05.p3d";
	};
	...
	class bldr_Swan_carousel_Arms: HouseNoDestruct
	{
		scope=1;
		model="\DZ\structures\specific\lunapark\proxy\swan_carousel_arms.p3d";
	};
	class bldr_Swan_carousel_Hydraulic: HouseNoDestruct
	{
		scope=1;
		model="\DZ\structures\specific\lunapark\proxy\swan_carousel_hydraulic.p3d";
	};
	class bldr_Swan_carousel_Wheels: HouseNoDestruct
	{
		scope=1;
		model="\DZ\structures\specific\lunapark\proxy\swan_carousel_wheels.p3d";
	};
	class bldr_Swan_carousel_Woodstairs: HouseNoDestruct
	{
		scope=1;
		model="\DZ\structures\specific\lunapark\proxy\swan_carousel_woodstairs.p3d";
	};
